...
public interface ProductTypeCrudService {
     ...
     */
    ResponseEntity<List<ProductType>> showAllProductsTypes();
     ...
     */
    ResponseEntity<ProductType> showProductTypeById(long id);
     ...
     */
    ResponseEntity<ProductType> addOrUpdateProductType(ProductType productType);
     ...
     */
    ResponseEntity<ProductType> delete (long id);
}
