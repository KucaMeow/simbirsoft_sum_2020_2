...
public interface MetricTypeCrudService {
     ...
     */
    ResponseEntity<List<MetricTypeDto>> showAllMetricTypes();
     ...
     */
    ResponseEntity<MetricTypeDto> showMetricTypeById(long id);
     ...
     */
    ResponseEntity<MetricTypeDto> addOrUpdateMetricType(MetricTypeDto metricType);
     ...
     */
    ResponseEntity<MetricTypeDto> delete (long id);
}
