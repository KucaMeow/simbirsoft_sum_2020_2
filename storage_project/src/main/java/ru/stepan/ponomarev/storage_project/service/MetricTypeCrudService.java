...
public interface MetricTypeCrudService {
     ...
     */
    ResponseEntity<List<MetricType>> showAllMetricTypes();
     ...
     */
    ResponseEntity<MetricType> showMetricTypeById(long id);
     ...
     */
    ResponseEntity<MetricType> addOrUpdateMetricType(MetricType metricType);
     ...
     */
    ResponseEntity<MetricType> delete (long id);
}
